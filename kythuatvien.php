...
<body>
    ...
    <div id="khung">
        <header>
            <div id="logo">
                <a href="kythuatvien.php"><img src="../GYM/image/logo.jpg" alt="" srcset=""></a>
                <p style="float:right"><a href="kythuatvien.php">GYM CR7</a></p>
            </div>
            
          
            <div id="noidung">
                <a href="kythuatvien.php">Trang chủ</a>
                <a href="kythuatvien.php?thongbao">Thông báo</a>
            </div>
            ...
            <div class="user-info">
                <?php
                    echo '
                        <a href="kythuatvien.php">
                            <img src="../GYM/image/avtNV/'.$r1["HinhAnhNV"].'" alt="" class="user">
                            <span>'.$r1["TenNV"].'</span>
                        </a>
                    ';
                ?>
            ...
            <div class="dropdown-menu">
                <ul>
                    <?php
                    echo'
                    <li><a href="kythuatvien.php?chitietnhanvien">Cập nhật</a></li>
                    <li><a href="kythuatvien.php?doimatkhau">Đổi mật khẩu</a></li>
                    <li><a href="kythuatvien.php?dangxuat">Đăng xuất</a></li>
                    ';
                    ?>
                </ul>
            </div>
        ...
        <section>
            <article id="a1">
            <a href="kythuatvien.php?dstb" class="menu-link">Danh Sách Thiết bị</a>
            <br>
            <a href="kythuatvien.php?dstb_duyet" class="menu-link">Danh Sách Thiết bị bảo trì</a>
            <br>
            <!--  -->
            <a href="kythuatvien.php?chitietnhanvien" class="menu-link">Thông tin cá nhân</a>
            <br>
            <a href="kythuatvien.php?doimatkhau" class="menu-link">Đổi mật khẩu</a>
            <br>
            <a href="kythuatvien.php?dangxuat" >Đăng xuất</a>
            </article>
            <article id="a2">

            <?php

 if(isset($_REQUEST["dstb"])){
    include_once("view/danhsachtb/index.php");
}else if(isset($_REQUEST["dstb_duyet"])){
    include_once("view/dstb_duyet/index.php");
}
...
}elseif(isset($_REQUEST["doimatkhau"])){

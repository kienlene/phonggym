<?php
    ...
    if (isset($_REQUEST["search"])) {
        ...
        if (!$con || $con->num_rows == 0) {
            ...
            echo "<script>window.location.href = 'quanly.php?dstv';</script>";
    ...
    if($con){
        echo "<br>";
        // echo "<center><a class='add-button' href='?themnv'>THÊM NHÂN VIÊN</a></center>";
        echo "<br>";
        echo "<br>";
        echo "<br>";
        echo "<br>";
        ...
        while($r = $con -> fetch_assoc()){
            echo "<tr>";
            echo "<td>".$r["MaTV"]."</td>";
            echo "<td> <a href='?ctnv=".$r["MaTV"]."'>".$r["TenTV"]."</a></td>";
            echo "<td>".$r["Email"]."</td>";
            echo "<td>".$r["Sdt"]."</td>";
            echo "<td>".$r["NgaySinh"]."</td>";
            echo "<td>".$r["HinhAnh"]."</td>";
            echo "<td>
                    <a class='edit-button' href='?snv=".$r["MaTV"]."'>sửa</a> 
                    <a class='delete-button' href='?xoanv=".$r["MaTV"]."' onclick='return confirm(\"Bạn có muốn xóa nhân viên này?\")'>xóa</a>
                </td>";
            echo "</tr>";
        }
        echo "</table>";
        ...
        <div class="study-info">
            <div class="left-col">
                <form action="" method="post">
                    <input class='delete-button' type="submit" name="delete" value="Danh Sách Nhân Viên Đã Xóa">
                    <p>5 xem chỉ tiết</p>
                </form>
            </div>

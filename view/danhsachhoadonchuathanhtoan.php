<?php
    ...
    $result = $p->selectdanhsachhoadonchuaTT($limit, $offset);
...
<?php if ($result): ?>
    <center>
        <h2>Danh Sách Hóa Đơn Khách Hàng Chưa Thanh Toán</h2>
        <hr>
...
<div class="pagination">
    <?php if ($page > 1): ?>
        <a href="ketoan.php?khchuatt&page=<?php echo $page - 1; ?>">Prev</a>
    <?php endif; ?>

    <?php for ($i = 1; $i <= $totalPages; $i++): ?>
        <a href="ketoan.php?khchuatt&page=<?php echo $i; ?>" <?php if ($i == $page) echo 'style="font-weight: bold;"'; ?>>
            <?php echo $i; ?>
        </a>
    <?php endfor; ?>

    <?php if ($page < $totalPages): ?>
        <a href="ketoan.php?khchuatt&page=<?php echo $page + 1; ?>">Next</a>
    <?php endif; ?>
</div>

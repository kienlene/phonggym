...
<body>
    <div id="khung">
        <header>
            <div id="logo">
                <a href="nhanvien.php"><img src="../GYM/image/logo.jpg" alt="" srcset=""></a>
                <p style="float:right"><a href="nhanvien.php">GYM CR7</a></p>
            </div>
            <div id="noidung">
                <a href="nhanvien.php">Trang chủ</a>
                <a href="nhanvien.php?thongbao">Thông báo</a>
                <?php
            ...
            <div class="user-dropdown">
                ...
                <div class="dropdown-menu">
                    <ul>
                        <?php
                        echo'
                        <li><a style="color: black;" href="nhanvien.php?chitietnhanvien">Cập nhật</a></li>
                        <li><a style="color: black;" href="nhanvien.php?doimatkhau">Đổi mật khẩu</a></li>
                        <li><a style="color: black;" href="nhanvien.php?dangxuat">Đăng xuất</a></li>
                        ';
                        ?>  
                    </ul>
                </div>
        ...
        <section>
            <article id="a1">
            <a href="nhanvien.php?dstv" class="menu-link">Danh Sách Thành Viên</a>
            <br>
            <a href="nhanvien.php?dstvhh" class="menu-link">Danh Sách Thành Viên Có Gói Tập Hết Hạn</a>
            <br>
            <a href="nhanvien.php?themtv" class="menu-link">Thêm Tài Khoản Thành Viên</a>
            <br>
            ...
            <?php
if (isset($_REQUEST["dstv"])) {
    echo '<form action="" method="post">';
        echo '<div class="search-container">';
            echo '<input type="text" name="texttimkiem" placeholder="Tìm kiếm theo Mã Thành Viên">';
            echo '<input type="submit" name="timkiem" value="Tìm Kiếm">';
        echo '</div>';
    echo '</form>';
    include_once("view/danhsachthanhvien.php");
}else if(isset($_REQUEST["cttv"])){
    include_once("view/danhsachthanhvien.php");
}else if(isset($_REQUEST["themtv"])){
    include_once("view/themthanhvien.php");
}else if(isset($_REQUEST["xoatv"])){
    include_once("view/xoaTV.php");
}else if(isset($_REQUEST["suatv"])){
    include_once("view/suathanhvien.php");
}else if(isset($_REQUEST["dangxuat"])){
    include_once("view/dangxuat.php");
}else if(isset($_REQUEST["chitietnhanvien"])){
...
}else if(isset($_REQUEST["dstvhh"])){
    echo '<form action="" method="post">';
        echo '<div class="search-container">';
            echo '<input type="text" name="texttimkiemhh" placeholder="Tìm kiếm theo Mã Thành Viên" required>';
            echo '<input type="submit" name="timkiemhh" value="Tìm Kiếm">';
        echo '</div>';
    echo '</form>';
    include_once("view/danhsachTVcogoitaphethan.php");
